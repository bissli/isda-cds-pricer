# ISDA CDS Standard Model - Jupyter Notebooks

Interactive Jupyter notebook versions of the Python examples for the ISDA CDS Standard Model library.

## Running Notebooks

Make sure you have the library installed, then start Jupyter:

```bash
poetry run jupyter notebook examples_nb/
```

Or with JupyterLab:

```bash
poetry run jupyter lab examples_nb/
```

## Notebook Files

### 01_basic_pricing.ipynb
**Basic CDS Pricing**
...
These notebooks cover the main functionality of the library:

| Module | Notebook Coverage |
|--------|-------------------|
| CDSPricer | 01, 02, 03 |
